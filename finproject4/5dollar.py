    ...
    for s_sym in ls_symbols: # for each symbol
        ...
        for i in range(1, len(ldt_timestamps)): # for each day
            ...
            if(f_symprice_yest >= 5.0 and f_symprice_today < 5.0):  
                ...
                print >>f1, str(today.year)+","+str(today.month)+","+str(today.day)+","+str(s_sym)+","+"Buy"+","+str(100)
                print >> f1, str(fiveday.year)+","+str(fiveday.month)+","+str(fiveday.day)+","+str(s_sym)+","+"Sell"+","+str(100)
